    ...
    def _construct_loader(self):
        ...
        for file in path_annotations_pickle:
            for tup in pd.read_pickle(file).iterrows():
                ...
                if self.cfg.EPICKITCHENS.DATA_LOAD_SELECTOR_LIST is not None and len(self.cfg.EPICKITCHENS.DATA_LOAD_SELECTOR_LIST) > 0:
                    # Proceed with selected dataset videos prefixes. Eg ["P01", "P02"]
                    if tup[0][0:3] in self.cfg.EPICKITCHENS.DATA_LOAD_SELECTOR_LIST:
